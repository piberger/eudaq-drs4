...
public:
    ...
    void setupUi(QMainWindow *wndRun)
    {
        ...
        gridLayout->addWidget(btnTerminate, 5, 2, 1, 1);
...
#ifndef QT_NO_TOOLTIP
        btnTerminate->setToolTip(QApplication::translate("wndRun", "Terminate the DAQ session", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        btnTerminate->setText(QApplication::translate("wndRun", "Terminate", 0, QApplication::UnicodeUTF8));

#ifndef V1742PRODUCER_HH
#define V1742PRODUCER_HH
...
class V1742Producer: public eudaq::Producer{
public:
  V1742Producer(const std::string & name, const std::string & runcontrol, const std::string & verbosity);
